...
from modules.joke_generator.module import joke_generator_module
...
bot.register(joke_generator_module, ['шутка','шутки','пошути', 'хочу посмеяться'], "А если напишешь мне 'шутка' - я расскажу тебе шутку!")
